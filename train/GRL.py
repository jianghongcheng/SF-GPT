# Ã¦ÂµÂÃ¨Â¯Â
# Ã¥Â¼ÂÃ¥ÂÂÃ¦ÂÂ¶Ã©ÂÂ´Ã¯Â¼Â2023/5/24 8:41
"""
...
from models_extra.common import Upsample, UpsampleOneStep
from models_extra.common.mixed_attn_block_efficient import (
    _get_stripe_info,
    EfficientMixAttnTransformerBlock,
)
from models_extra.common.ops import (
    bchw_to_blc,
    blc_to_bchw,
    calculate_mask,
    calculate_mask_all,
...
from models_extra.common.swin_v1_block import (
    build_last_conv,
)
...
class GRL(nn.Module):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        self.first_new  = nn.Conv2d(4, 1, kernel_size=3, padding=1)
